...
As part of the nv-isv-tools workspace:
...
- `ISV_LAB_SERVICE_ENDPOINT`: API endpoint URL (e.g., `https://stg-api.ncp-isv-validation-labs.nvidia.com`)
...
export ISV_LAB_SERVICE_ENDPOINT="https://stg-api.ncp-isv-validation-labs.nvidia.com"
