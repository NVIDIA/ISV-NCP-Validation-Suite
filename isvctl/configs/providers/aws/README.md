...
| [`config/security.yaml`](config/security.yaml) | BMC isolation, BMC protocol security, API endpoint isolation, cert rotation, KMS options, centralized KMS, BYOK, SA credential auth | - |
