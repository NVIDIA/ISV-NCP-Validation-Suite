...
| `query_resource_discovery` | test | `providers/nico/scripts/governance/query_resource_discovery.py` | `polls`, `poll_interval_seconds`, `identifiers_stable`, `unstable_identifiers`, `new_identifiers`, `resources_discovered`, `resources[].{resource_id,resource_type,delivery_reason,delivery_reason_source,discovered}` |
