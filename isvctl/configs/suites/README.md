...
The shared cordon reference requires `tests.settings.breakfix_allow_mutation: true`; multi-node clusters also require `tests.settings.breakfix_node` to name a dedicated test node.
