...
Deploys nv-isv-tools to a remote machine and runs validation tests.
"""
...
def run(
    ...
    remote_dir: Annotated[
        ...
        typer.Option(
            "--remote-dir",
            "-d",
            help="Remote directory (default: /home/<user>/nv-isv-tools)",
        ),
    ] = None,
    config: Annotated[
        list[Path] | None,
    ...
    effective_remote_dir = remote_dir or f"/home/{user}/nv-isv-tools"
    ...
    if prod:
        os.environ["ISV_LAB_SERVICE_ENDPOINT"] = PROD_ISV_LAB_SERVICE_ENDPOINT
        os.environ["ISV_SSA_ISSUER"] = PROD_ISV_SSA_ISSUER
    else:
        os.environ["ISV_LAB_SERVICE_ENDPOINT"] = STG_ISV_LAB_SERVICE_ENDPOINT
        os.environ["ISV_SSA_ISSUER"] = STG_ISV_SSA_ISSUER
        ...
        if not lab_id:
            ...
            if not can_upload:
                ...
                typer.echo(
                    ...
                    + " Test results will not be uploaded to isvreporter"
                )
                upload_results = False
    ...
    archive_name = "nv-isv-tools.tar.gz"
