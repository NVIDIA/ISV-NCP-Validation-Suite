...
def test_required_settings_gate_opt_in_steps() -> None:
    ...
    disabled = _apply_step_setting_gates(steps, {"allow_mutation": False})
    non_boolean = _apply_step_setting_gates(steps, {"allow_mutation": 1})
    enabled = _apply_step_setting_gates(steps, {"allow_mutation": True})
