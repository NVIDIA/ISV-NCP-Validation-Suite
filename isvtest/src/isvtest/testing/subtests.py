...
container-based validators like k8s-platform-validator.
...
def _inject_subtests_into_junit(junit_path: Path, reports: list[SubTestReport]) -> None:
    ...
    try:
        ...
        for parent_nodeid, parent_reports in subtests_by_parent.items():
            ...
            # pytest JUnit uses format like "test_validation[K8sPlatformValidatorFunctional]"
            # nodeid is like "isvtest/src/.../test_validation[K8sPlatformValidatorFunctional]"
